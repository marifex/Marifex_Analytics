...
export const widgetPalettes: WidgetPalette[] = [
  ...
  { key: 'classic_blue', label: 'Classic Blue', type: 'Gradient', background: '#EFF6FF', backgroundEnd: '#DBEAFE', text: '#1E3A8A', muted: '#475569', border: '#BFDBFE', colors: ['#1D4ED8', '#2563EB', '#3B82F6'] },
  { key: 'teal_green', label: 'Teal Green', type: 'Gradient', background: '#ECFDF5', backgroundEnd: '#D1FAE5', text: '#064E3B', muted: '#475569', border: '#A7F3D0', colors: ['#047857', '#10B981', '#34D399'] },
  { key: 'deep_purple', label: 'Deep Purple', type: 'Gradient', background: '#F5F3FF', backgroundEnd: '#EDE9FE', text: '#4C1D95', muted: '#475569', border: '#DDD6FE', colors: ['#5B21B6', '#8B5CF6', '#A78BFA'] },
  { key: 'warm_amber', label: 'Warm Amber', type: 'Gradient', background: '#FFFBEB', backgroundEnd: '#FEF3C7', text: '#78350F', muted: '#64748B', border: '#FDE68A', colors: ['#B45309', '#FBBF24', '#FDE68A'] },
  { key: 'coral_red', label: 'Coral Red', type: 'Gradient', background: '#FEF2F2', backgroundEnd: '#FEE2E2', text: '#7F1D1D', muted: '#64748B', border: '#FECACA', colors: ['#B91C1C', '#EF4444', '#FCA5A5'] },
  { key: 'sky_blue', label: 'Sky Blue', type: 'Gradient', background: '#F0F9FF', backgroundEnd: '#E0F2FE', text: '#0C4A6E', muted: '#475569', border: '#BAE6FD', colors: ['#2563EB', '#60A5FA', '#93C5FD'] },
  { key: 'bright_orange', label: 'Bright Orange', type: 'Gradient', background: '#FFF7ED', backgroundEnd: '#FFEDD5', text: '#7C2D12', muted: '#64748B', border: '#FED7AA', colors: ['#C2410C', '#F97316', '#FB923C'] },
  { key: 'rose_pink', label: 'Rose Pink', type: 'Gradient', background: '#FFF5F5', backgroundEnd: '#FFE4E6', text: '#881337', muted: '#475569', border: '#FECDD3', colors: ['#BE185D', '#F472B6', '#FB7185'] },
  { key: 'forest_green', label: 'Forest Green', type: 'Gradient', background: '#F0FDF4', backgroundEnd: '#DCFCE7', text: '#14532D', muted: '#475569', border: '#BBF7D0', colors: ['#065F46', '#34D399', '#6EE7B7'] },
  { key: 'slate_gray', label: 'Slate Gray', type: 'Gradient', background: '#F8FAFC', backgroundEnd: '#F1F5F9', text: '#0F172A', muted: '#475569', border: '#E2E8F0', colors: ['#4B5563', '#9CA3AF', '#CBD5E1'] },
];
