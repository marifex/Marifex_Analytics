...
define('PLUGIN_MARIFEX_VERSION', '0.9.2-dev');
...
function plugin_init_marifex(): void
{
    ...
    if (is_string($requestPath) && (
        ...
        $PLUGIN_HOOKS[Hooks::ADD_CSS]['marifex'][] = 'css/marifex.css?v=0.9.2-dev.1';
        $PLUGIN_HOOKS[Hooks::ADD_JAVASCRIPT]['marifex'][] = 'js/dashboard.js?v=0.9.2-dev.1';
    }
}
